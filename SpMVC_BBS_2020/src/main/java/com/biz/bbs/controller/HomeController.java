...
public class HomeController {
	...
	public String home(Locale locale, Model model) {
		/*
		 * Controller의 method에서 home 문자열을 return 하면
		 * 1. tiles-layout.xml에서 definition 항목에 home으로 선언된 tag가 있는지 검사
		 * 2. 만약에 있으면 template으로 선언된 *.jsp(layout.jsp)파일을 찾는다. 
		 ...
		 * 6. layout.jsp 파일과 합성하여 rendering을 준비한다.
		 * 
		 * 7. 만약 home 이라고 선언된 항목이 tiles-layout.xml에 없을 경우는
