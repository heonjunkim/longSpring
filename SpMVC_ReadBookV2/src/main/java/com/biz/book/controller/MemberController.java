...
public class MemberController {
	...
	public String mypage(@ModelAttribute("memberVO") UserDetailsVO userVO,
		 ...
		 *  전달이 된다.
		 *  객체에서 getPrincipal() method를 호출하여 데이터를 UserDetailsVO의 userVO 객체에
	...
	public UserDetailsVO userInfo(Principal principal,  
		...
		// 		서버의 Session에 직접 접근하여 사용자 정보를 추출하는 방법으로 
		// 		보안에 상당히 취약!해서 사용을 지양하는 방법
...
//		userVO = (UserDetailsVO) upa.getPrincipal();
		...
		// 2. securiyContextHoler로 부터 추출하는 방법
