...
public class BlogServiceImplV1 implements BlogService {
	...
	// 객체 주입
	// @Autowired를 빼먹으면?
	// NullPointerException이 나온다
	// 10 개중의 9개는 오토 태그 빼먹은것
	
	@Autowired
	
	// mybatis-context에서 설정한 SqlSessionTemplete를 가져와서
	// 사용할 수 있도록 선언
	...
	/*
	 * INSERT 문을 실행했을때 많이 발생하는 Exception
