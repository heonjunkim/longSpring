...
public class BlogService {
	/*
	 * ServletContext tomcat 위에서 실행되는 WA(Web App)의 모든 정보를 담고있는 객체 이미 Sprint
	 * project에서는 ServletContext 클래스의 객체 인스턴스가 만들어 있기 때문에 가져다 사용하기 위해서 AutoWired로 묶어
	 * 주기
	 */
	@Autowired
	...
	public void selectAll() {
		...
		try {
			...
			// 서버의 root path와 blog 파일 이름을 묶어서
			// 파일관련 연산을 수행할때 사용할 file객체 생성
	...
	public void insert(BlogVO blogVO) {
		...
		// Server의 class들이 저장되는 Folder 정보 가져오기
