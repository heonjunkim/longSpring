...
public class BookVO {
	...
	private String price;  		//	정가   정보이다. 절판도서 등으로 가격이 없으면 나타나지 않는다.
	private String discount; 	//	할인 가격 정보이다. 절판도서 등으로 가격이 없으면 나타나지 않는다.
	private String publisher; 	//	출판사 정보이다.
	private String isbn; 		// 넘버이다.
	private String description;	//색 결과 문서의 내용을 요약한 패시지 정보이다. 문서 전체의 내용은 link를 따라가면 읽을 수 있다. 패시지에서 검색어와 일치하는 부분은 태그로 감싸져 있다.
