...
import com.biz.book.service.MemberServiceImplV1;
...
public class MemberController {
	...
	public String join(@ModelAttribute("memberVO") UserDetailsVO userVO , Model model) {
			...
			// spring에서는 가급적으로 new를 사용하지 않는다 메모리도 아끼고 ...등
