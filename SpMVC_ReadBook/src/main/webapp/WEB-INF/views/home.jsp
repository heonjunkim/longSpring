...
<link href="${rootPath}/static/css/index.css?ver=2020-09-28-004" rel="stylesheet" />
<script src="https://code.jquery.com/jquery-latest.min.js"></script>
<script>
	// js 파일에서 ${rootPath} 값을 참조하기 위해서
	// rootPath 변수를 전역으로 선언해 둔다
	var rootPath = "${rootPath}"
</script>
<script src="${rootPath}/static/js/main-nav.js?ver=2020-09-28-001"></script>
</head>
<body>
	<header>
	...
	<nav id="main-nav">
		<ul>
			...
			<sec:authorize access="isAuthenticated()">
				...
				<li><form:form action="${rootPath}/logout"><button>로그아웃</button>
					</form:form></li>
			</sec:authorize>
